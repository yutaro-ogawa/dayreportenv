//global
var eventData_JSON = null;
var project_color_global = null;
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      $(data).each(function() {
        ...
        op3.value = this.id; //value値
        op3.text = this.title; //テキスト値
        document.getElementById("kinputModal-project").appendChild(op3);
      })
    },
    error: function(data) {
      console.log("Ajax create Failed")
